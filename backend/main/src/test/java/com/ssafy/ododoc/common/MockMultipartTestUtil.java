...
import com.ssafy.ododoc.common.type.CustomMultipartFile;
...
public class MockMultipartTestUtil extends TestBase {
    ...
    public MockMultipartFile 이미지_생성() {
        try {
            ...
            return createMockMultipartFile(file, "image", "image/png");
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public MockMultipartFile 텍스트_파일_생성(String filename, String inputContent, String fieldName) {
        try {
            ...
            return createMockMultipartFile(file, fieldName, "text/txt");
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    private MockMultipartFile createMockMultipartFile(File file, String fieldName, String fileType) throws IOException {
