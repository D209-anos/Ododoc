...
public class DirectoryTestUtil extends TestBase {
    ...
    public Long 폴더_생성(String token, Long parentId, MockMvc mockMvc) throws Exception {
        MvcResult mvcResult = mockMvc.perform(
                post("/directory")
                        .header(ApiTest.AUTH_HEADER, token)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(directorySteps.폴더정보_생성(parentId)))
        )
    ...
    public void 디렉토리_삭제_휴지통(String token, Long directoryId, MockMvc mockMvc) throws Exception {
        mockMvc.perform(
    ...
    public void 디렉토리_삭제_영구(String token, Long directoryId, MockMvc mockMvc) throws Exception {
        mockMvc.perform(
