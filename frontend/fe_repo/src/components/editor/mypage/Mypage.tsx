...
function Mypage() {
    ...
    return (
        <div style={{ textAlign: 'center', padding: '20px', display: 'flex', flexDirection: 'row', justifyContent: 'center', width: "100%", height: '85vh' }}>
            <div style={{width: '50%', display : 'flex', flexDirection:'column', justifyContent: 'space-around' }}>
                <h1>개발 경험치</h1>
                <CountUp
                    end={totalCount}
                    duration={2.75}
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', marginTop: '40px' }}>
                    <div style={{width :'40%'}}>
                        <h2>에러 발견</h2>
                        <CountUp end={errorCount} duration={2.75} separator="," style={{fontSize : '3rem'}} />
                    </div>
                    <div style={{width :'40%'}}>
                        <h2>사이트 방문</h2>
                        <CountUp end={websiteVisits} duration={2.75} separator="," style={{fontSize : '3rem'}}/>
                    </div>
                    <div style={{width :'40%'}}>
                        <h2>빌드 성공</h2>
                        <CountUp end={builds} duration={2.75} separator="," style={{fontSize : '3rem'}}/>
                    </div>
                    <div style={{width :'40%'}}>
                        <h2>검색 횟수</h2>
                        <CountUp end={keywordSearches} duration={2.75} separator="," style={{fontSize : '3rem'}}/>
                    </div>
                </div>
            </div>
            <div style={{ width: '50%' }}>
                <h1>당신은 <span style={{color: 'orange'}}>{nickname}</span> 입니다</h1>
                <br />
                <img src={imageForNickname} alt="Profile" style={{width: '100%', height:'90%'}} />
            </div>
        </div>
    );
}
