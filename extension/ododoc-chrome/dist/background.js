...
const logout = async () => {
  try {
    ...
    const response = await _api__WEBPACK_IMPORTED_MODULE_0__["default"].get('/oauth2/logout', {});
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _service_user__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./service/user */ "./src/service/user.ts");

let socket = null;
let start = false;
let visitedUrls = new Set();
let accessToken = null;
let socketReconnect = true; // 웹소켓 재연결
let fileId = 0;
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.command === "start") {
    ...
    (0,_service_user__WEBPACK_IMPORTED_MODULE_0__.logout)();
  }
});
